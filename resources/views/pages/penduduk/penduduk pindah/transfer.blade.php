        ...
        <section class="section">
            <div class="card border border-2">
                <div class="card-header py-0 border-bottom d-flex align-items-center justify-content-between">
                    {{-- Export & Import --}}
                    <div class="my-3">
                        <a class="btn btn-secondary" href="{{ route('transfer.print') }}" target="_blank">Print PDF</a>
                        <a class="btn btn-success" href="{{ route('transfer.export') }}">Export</a>
                        <a class="btn btn-success" href="{{ route('transfer.exportTemplate') }}">Export Template</a>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('transfer.import') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <form method="GET">
                                        ...
                                        <div class="modal-footer d-flex justify-content-between">
                                            <button type="submit" class="btn btn-primary" formaction="{{ route('transfers.index') }}">Terapkan</button>
                                            <div>
                                                <button type="submit" class="btn btn-danger" formaction="{{ route('filter-reset-transfer') }}">Reset</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        @if(Auth::user()->role != 'Watcher')
                                                            <a href="{{ route('transfers.edit', $resident->id) }}" class="btn btn-warning text-center px-4">
                                                                Edit
                                                            </a>
                                                        @endif
                                                    </div>
