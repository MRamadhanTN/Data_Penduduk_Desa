                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" method="post" id="locations" action="{{ route('families.store') }}">
                                        @csrf
                                        @method('POST')
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" id="resident_id" class="form-control @error('residents_id') is-invalid @enderror border-2" name="resident_id" value="{{ old('residents_id') }}" autofocus>
                                                        <option disabled="" selected class="text-gray-500">Pilih Kepala Keluarga</option>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="no_kk" class="form-control @error('no_kk') is-invalid @enderror border-2" name="no_kk" autocomplete="none" value="{{ old('no_kk') }}" autofocus>
                                                    @error('no_kk')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
