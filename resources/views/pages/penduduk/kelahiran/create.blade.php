    ...
    <div id="main">
        ...
        <div class="card p-5 border border-2">
            <div class="title text-center py-3" style="line-height: 7px">
                <h2 class="text-primary">Data Kelahiran</h2>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" method="POST" id="locations" action="{{ route('births.store') }}">
                                        @csrf
                                        @method('POST')
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="resident_id" class="form-control @error('residents_id') is-invalid @enderror border-2" name="resident_id">
                                                        <option disabled="" selected class="text-gray-500">Cari nama</option>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="weight" class="form-control @error('weight') is-invalid @enderror border-2" name="weight" autocomplete="none" value="{{ old('weight') }}">
                                                    @error('weight')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="width" class="form-control @error('width') is-invalid @enderror border-2" name="width" autocomplete="none" value="{{ old('width') }}">
                                                    @error('width')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
