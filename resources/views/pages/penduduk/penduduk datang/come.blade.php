        ...
        <section class="section">
            <div class="card border border-2">
                <div class="card-header py-0 border-bottom d-flex align-items-center justify-content-between">
                    {{-- Export & Import --}}
                    <div class="my-3">
                        <a class="btn btn-secondary" href="{{ route('come.print') }}" target="_blank">Print PDF</a>
                        <a class="btn btn-success" href="{{ route('come.export') }}">Export</a>
                        <a class="btn btn-success" href="{{ route('come.exportTemplate') }}">Export Template</a>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('come.import') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title text-white" id="exampleModalLabel">~~ Filter Penduduk Datang ~~</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form method="GET">
                                        ...
                                        <div class="modal-footer d-flex justify-content-between">
                                            <button type="submit" class="btn btn-primary" formaction="{{ route('comes.index') }}">Terapkan</button>
                                            <div>
                                                <button type="submit" class="btn btn-danger" formaction="{{ route('filter-reset-come') }}">Reset</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        @if(Auth::user()->role != 'Watcher')
                                                            <a href="{{ route('comes.edit', $resident->id) }}" class="btn btn-warning text-center px-4">
                                                                Edit
                                                            </a>
                                                        @endif
                                                    </div>
